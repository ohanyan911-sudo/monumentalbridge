...
const titles = [
	...
	"ԻՐԱԿԱՆ ԳԵՆՈՄԻ 60-ԱԿԱՆ ԲԱՑԱՀԱՅՏՈՒՄԸ ՄՇԱԿՈՒՅԹԻ ԹՐԹԻՌԻՑ՝ ԿԵՐՏՎԱԾ ԷՊԻԳԵՆԵՏԻԿ ԼՈՒՅՍՈՎ",
	"Գ Դ Ե Ա Խ Զ Վ Ն-ն ՈՐՊԵՍ ԿԵՆՍԱԲԱՆՈՒԹՅԱՆ ԼԵԶՎԱՄՏԱԾՈՂ ԿԱՄՈՒՐՋ",
	"ՉՎՆԱՍԵԼՈՒ ԳԻՏԱԿՑՈՒԹՅՈՒՆԻՑ ԾՆԵԲԵԿՎԱԾ ԷԹԻԿԱՅԻ ԾԻԼԵՐԸ",
];
